...
SYSTEM_PROMPT = (
    ...
    "IMPORTANT: For any queries about current time, date, day of week, or time-related information, ALWAYS use the get_current_time function instead of relying on static information. "
    ...
    "When you use functions to get information (like weather, time, reminders), incorporate the results naturally into your response without saying 'I checked' or 'I used a tool'. "
    "\n\n"
